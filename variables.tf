...
variable "db_sku_name" {
  description = "PostgreSQL SKU (e.g., GP_Standard_D2s_v3 for 2 vCore, 8GB RAM)"
  type        = string
  default     = "GP_Standard_D2s_v3"  # General Purpose, 2 vCore, 8GB RAM - avoids out-of-shared-memory on migrations
}
